...
const Centre:React.FC<CentreProps> = (props)=>{
    ...
    return(
      ...
      <div >
        <div className="mb-4 h-16 bg-[#F8F8FB] mt-8 rounded-2xl shadow-xl flex items-center pl-3 font-black text-2xl hover:bg-[#3d8a3c] hover:text-white transition duration-300 ease-in-out" style={{ fontFamily: 'Lato', color: '#274C77' }}>
          POST A JOB
        </div>
